      ...
      <div className="container mx-auto px-4 max-w-4xl space-y-6">
        <div className="flex items-center gap-4 bg-white p-6 rounded-2xl shadow-sm border border-gray-100">
          ...
          <div>
            ...
            <p className="text-[10px] text-gray-400 font-bold uppercase tracking-widest mt-0.5">Tracking {orders.length} active orders</p>
          </div>
        </div>
              ...
              >
                ...
                <div className="p-5 sm:p-8 flex items-start gap-4 sm:gap-6">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="text-sm sm:text-lg font-bold text-gray-900 leading-tight mb-2 line-clamp-2">
                      {order.product_details?.name}
                    </h3>

                    <div className="flex flex-wrap items-center gap-x-6 gap-y-2">
                      <div className="flex items-center gap-1.5 text-green-600 font-black text-base sm:text-lg">
