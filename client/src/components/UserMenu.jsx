  ...
  return (
    <div>
      ...
      <div className='text-sm grid gap-3  '>
       ...
       {
        isAdmin(user.role)&& (
          <Link onClick={handleClose} to={"/dashboard/manage-gift-cards"} className='hover:bg-gray-100  py-1'>Manage Gift Cards</Link>
          
        )
       }
        {
          isAdmin(user.role) && (
            <Link onClick={handleClose} to={"/dashboard/admin-orders"} className='hover:bg-gray-100 py-1'>All Orders</Link>
          )
        }
